<x-layout>
    ...
    <x-section-head>{{__('messages.Add') . ' ' . __('messages.Service Committees')}}</x-section-head>

    <div class="container d-flex justify-content-center align-items-center">
        <form action="{{ route('serviceCommittee.store') }}" method="post" class="row g-2 col-md-12 col-lg-8 mt-1">
            @csrf
