        ...
        <div class="row justify-content-center">
            <div class="col-lg-10 col-xl-8">
                <div class="glass-card p-4 p-md-5">
                    <form action="{{ route('serviceCommittee.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <x-forms.textarea name="default_footer" id="default_footer" label="{{ __('messages.Default Report Footer') ?? 'Default Report Footer' }}" maxlength="1000"/>
                                ...
                                <div class="col-12">
                                    <div class="mb-3 p-3 rounded-3" style="border: 1px dashed var(--glass-border); background: rgba(0,0,0,0.01);">
                                        ...
                                        <div id="logo-preview-container" class="d-none mt-2">
                                            <p class="text-secondary small mb-1">{{ __('messages.Logo Preview') ?? 'Logo Preview' }}:</p>
                                            <img id="logo-preview" src="#" alt="Logo Preview" class="img-thumbnail" style="max-height: 150px; border-radius: 8px;">
                                        </div>
                                    </div>
                                </div>
                            </div>
