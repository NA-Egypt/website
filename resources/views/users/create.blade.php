                ...
                <form method="POST" action="{{ route('users.store') }}">
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="display_name" id="display_name" class="form-control glow-input @error('display_name') is-invalid @enderror" value="{{ old('display_name') }}" required>
                            @error('display_name')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" name="email" id="email" class="form-control glow-input @error('email') is-invalid @enderror" value="{{ old('email') }}" required>
                            @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                                            ...
                                            @foreach ($category['permissions'] as $permission)
                                                <div class="col-md-6">
                                                    <div class="p-3 border rounded-3 bg-white d-flex align-items-center justify-content-between shadow-sm">
                                                        ...
                                                        <label class="form-switch-premium m-0">
                                                            <input type="checkbox" class="permission-checkbox" name="permissions[]" value="{{ $permission->id }}" id="permission_{{ $permission->id }}">
                                                            <span class="slider-premium"></span>
                                                        </label>
                                                    </div>
                                                </div>
