                        ...
                        <div class="list-group">
                            @foreach($availableWorkgroupDrafts as $wgReport)
                                <div class="list-group-item d-flex justify-content-between align-items-center p-3" id="wgReportItem-{{ $wgReport->id }}">
                                    ...
                                    <button type="button" class="btn btn-sm btn-success px-3 embed-btn" data-report-id="{{ $wgReport->id }}" onclick="embedWorkgroupReport({{ $wgReport->id }})">
                                        <i class="bi bi-plus-lg me-1"></i> {{ __('messages.Embed into Report') }}
                                    </button>
                                </div>
                            @endforeach
                        </div>
