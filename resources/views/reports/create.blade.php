<x-layout>
    ...
    <div class="container mt-4">
        ...
        <form action="{{ route('committee-reports.store') }}" method="POST" id="reportForm">
            @csrf
            ...
            <button type="submit" class="btn btn-primary btn-lg w-100 mb-5">{{ __('messages.Submit Report') }}</button>
        </form>
    </div>
