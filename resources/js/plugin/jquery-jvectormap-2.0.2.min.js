...
jvm.SVGCanvasElement.prototype.applyTransformParams = function(scale, transX, transY) {
  ...
  const validScale = !isNaN(scale) ? scale : 1;       // Default scale to 1
const validTransX = !isNaN(transX) ? transX : 0;   // Default translateX to 0
const validTransY = !isNaN(transY) ? transY : 0;   // Default translateY to 0

this.rootElement.node.setAttribute(
    'transform',
    `scale(${validScale}) translate(${validTransX}, ${validTransY})`
);
